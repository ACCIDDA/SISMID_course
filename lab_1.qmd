...
🧠 **Question**: Use the Poisson distribution to model the number of cases in the example above, calculate the growth or decay rate and estimate the peak time? How these estimates differ from those obtained using the negative binomial distribution?
