---
title: "Outbreak Reconstruction - Part1"
format:
  html:
    self-contained: true
editor: visual
...
-   **`PHM-EVD-linelist-2017-11-25.xlsx`**: A linelist of reported cases.\
    📁[Download the file here](https://www.reconlearn.org/data/PHM-EVD-linelist-2017-11-25.xlsx) and place it in a `data/` folder.

-   **`PHM-EVD-contacts-2017-11-25.xlsx`**: A contact tracing dataset containing information on reported contacts between cases.\
    📁 [Download the file here](https://www.reconlearn.org/data/PHM-EVD-contacts-2017-11-25.xlsx) and place it in the same `data/` folder.
...
2.  Common source exposure (*i.e.* same infector), or limited viral evolution between transmission events can result in genetically similar viruses in cases that are not directly linked.
...
-   `epiparameter`: Part of LSHTM’s [Epiverse initiative](https://data.org/initiatives/epiverse/), offering access to standardised disease parameters
